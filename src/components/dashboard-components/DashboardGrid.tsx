...
function DashboardGrid() {
  return (
   <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6 ml-0 md:ml-[32px] w-full">
      ...
      <DashboardCard className="min-h-65">
        ...
        <div className="flex items-center justify-between mb-5">
          <div className="flex items-center gap-2">
            ...
            <h2 className="text-[16px] text-[#0E121B] leading-[24px] tracking-[-1.1%] w-[72px] h-[24px] font-medium">
              My Cards
            </h2>
          </div>
          ...
          <button className="flex items-center gap-2 border border-gray-300 rounded-xl px-4 py-2 hover:bg-gray-100 transition">
            ...
            <span className="w-[63px] h-[20px] font-medium text-[14px] leading-[20px] tracking-[-0.6%] text-[#525866]">
              Add Card
            </span>
          </button>
        </div>
        ...
        <div className="grid grid-cols-3 border bg-[#FFFFFF] rounded-[6px] w-full border-[#E1E4EA] overflow-hidden mt-[16px]">
          ...
          <button className="pt-[4px] pl-[12px] pr-[12px] pb-[4px] bg-[#F5F7FA] border border-[#E1E4EA]">
            <p className="font-medium leading-[16px] tracking-[0%] text-[12px] text-[#0E121B]">
              Weekly
            </p>
          </button>

          <button className="pt-[4px] pl-[12px] pr-[12px] pb-[4px] gap-[4px] border bg-[#FFFFFF] border-[#E1E4EA]">
            <p className="font-medium leading-[16px] tracking-[0%] text-[12px] text-[#525866]">
              Monthly
            </p>
          </button>
        ...
        <div className="flex items-center justify-between mt-5">
          ...
          <div className="flex items-center gap-4 mt-[20px]">
            ...
            <div>
              ...
              <span className="text-[18px] font-medium leading-[24px] tracking-[-1.5%] w-[84px] h-[24px] text-[#0E121B] flex items-baseline gap-1">
                $1,500.00
      ...
      <DashboardCard className="min-h-65">
        ...
        <div className="flex items-center justify-between mb-6">
          ...
          <button className="font-medium leading-[20px] text-[14px] tracking-[-0.6%] text-[#525866] bg-[#FFFFFF] border p-[6px] rounded-full border-[#E1E4EA] gap-0.5 w-[66px] h-[32px]">
            See All
          </button>
        </div>
        ...
        <div className="flex items-center justify-between py-4">
          ...
          <div className="flex items-center gap-4">
            ...
            <FiChevronRight className="text-gray-500 p-[1px] flex gap-[2px] rounded-[2px] w-fit h-[20px]" />
          </div>
        </div>
        ...
        {/* Bottom Button */}
        <button className="w-full h-fit bg-[#FFFFFF] border border-[#E1E4EA] rounded-[8px] p-2 justify-center gap-1 transition mt-[14px] mb-[20px]">
          <div className="w-5 h-5">
            <span className="w-[10.5px] h-[10.5px] mt-1 ml-[4.75px] text-[#525866]">
              +
            </span>
          </div>

          <span className="w-31 h-5 leading-5 tracking-[-0.6%] text-[14px] font-medium text-[#525866]">
            Save a New Action
          </span>
        </button>
      ...
      <DashboardCard className="min-h-[280px]">
        ...
        <div className="flex items-center justify-between border-b border-gray-200 pb-5">
          ...
          <button className="border rounded-full pt-[6px] pb-[6px] pr-[6px] pl-[10px] gap-[2px] bg-[#FFFFFF] border-[#E1E4EA] flex flex-row h-[32px] w-[106px] whitespace-nowrap mb-[16px]">
            <span className="text-[14px] leading-[20px] tracking-[-0.6%] font-normal w-[68px] h-[20px] text-[#0E121B]">
              Last Week
            </span>

            <span className="w-[20px] h-[20px] mt-0.5 text-[#525866]">
              <IoIosArrowDown />
            </span>
          </button>
        </div>
